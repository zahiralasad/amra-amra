...
function RegisterToEnter() {
  ...
  useEffect(() => {
    ...
    let cost = numberOfMales * 120 + numberOfFemales * 120 + numberOfBigKids * 80 + gameCost;
    // let cost = 100;
  ...
  // const defineGameCost = (game) => {
  //   if (game.name.includes("Doubles")) {
  //     return gameCodes[game.id]?.trim() ? "0kr" : "50kr";
  //   } else {
  //     return "25kr";
  //   }
  // };
