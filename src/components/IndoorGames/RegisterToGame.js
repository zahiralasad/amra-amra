...
function RegisterToGame() {
  ...
  { id: "PenFightSingles", name: "PenFightSingles", label: "কলম খেলা Singles " },
  { id: "LudoDoubles", name: "LudoDoubles", label: "Ludo Doubles " },
  { id: "Chess", name: "Chess", label: "Chess " }]);
  const [femaleGames] = useState([{ id: "FiveStones", name: "FiveStones", label: "পাচগুটি " },
  { id: "CarromDoubles", name: "CarromDoubles", label: "Carrom Doubles " },
  { id: "InternationalBridge", name: "InternationalBridge", label: "International Bridge " },
  { id: "29", name: "29", label: "29 " },
  { id: "LudoDoubles", name: "LudoDoubles", label: "Ludo Doubles " },
            ...
            <form className="needs-validation" id="entryForm" onSubmit={(e) => Submit(e)}>
              <div className="ps-1 pe-1 pt-3 pb-2 mb-1 rounded border">
                <div className="d-flex mb-3 input-group border-bottom pb-1">
                  ...
                  <p className="ms-2">(150kr/adult)</p>
                </div>
                    ...
                    const handleGameSelection = (event, gameName) => {
                      ...
                      if (event.target.checked) {
                        ...
                        if ((gameName === "TableTannisSingles")
                          ...
                          || (gameName === "Uno")) {
                          setMaleGameCost((prevGameCost) => prevGameCost + 30)
                        } else {
                          if (inputElement.value === "") {
                            setMaleGameCost((prevGameCost) => prevGameCost + 60)
                          }
                          // else
                          // labelText.textContent = `${gameName} (0kr)`;
                        }
                        ...
                        {maleGames.map((game) => {
                          ...
                          const defineGameCost = (gameName, code) => {
                            if (
                              ...
                              return code && code.trim() ? "0kr" : "60kr";
                            }
                            return "30kr";
                          };
                          return (
                    ...
                    const handleGameSelection = (event, gameName) => {
                      ...
                      if (event.target.checked) {
                        ...
                        if ((gameName === "TableTannisSingles")
                          ...
                          || (gameName === "LudoKidsSingles")
                          || (gameName === "Uno")) {
                          setFemaleGameCost((prevGameCost) => prevGameCost + 30)
                        } else {
                          if (inputElement.value === "") {
                            setFemaleGameCost((prevGameCost) => prevGameCost + 60)
                          }
                        }
                      } else
                        if ((gameName === "TableTannisSingles")
              ...
              <div className="ps-1 pe-1 pt-3 pb-2 mb-1 rounded border">
                <div className="d-flex input-group mb-3 border-bottom pb-1">
                  ...
                  <p className="ms-2">(100kr/child)</p>
                </div>
                    ...
                    const handleGameSelection = (event, gameName) => {
                      ...
                      if (event.target.checked) {
                        ...
                        if ((gameName === "TableTannisSingles")
                          ...
                          || (gameName === "ChessKids")
                          || (gameName === "FiveStones")
                          || (gameName === "PenFightKidsSingles")
                          || (gameName === "LudoSingles")
                          || (gameName === "LudoKidsSingles")
                          || (gameName === "Uno")) {
                          setKidsGameCost((prevGameCost) => prevGameCost + 30)
                        } else {
                          if (inputElement.value === "") {
                            setKidsGameCost((prevGameCost) => prevGameCost + 60)
                          }
                        }
                      } else
                        if ((gameName === "TableTannisSingles")
              ...
              <div className="ps-1 pe-1 pt-3 pb-2 mb-1 rounded border">
                <div className="input-group  mb-3 border-bottom pb-1">
                  ...
                  <span className="input-group-text text-wrap"> Number of children between 0 to 4 years old</span>
              ...
              <div className="ps-1 pe-1 pt-3 pb-2 mb-1 rounded border">
                <div className="form-group input-group  mb-3">
                  ...
                  <span className="input-group-text" style={{ width: "100px" }}>Phone</span>
