...
function Admin() {
    ...
    const dataUrl = 'https://script.google.com/macros/s/AKfycby81xq_hqfwg31p9rvFcfyKthl0SEW4LH2t2XfrydLtZGSbyo9mR-91-i4VoKp8GL9N/exec';
        ...
        axios.post(dataUrl, formData)
            .then(response => {
                ...
                if (response.data.status === "successful") {                                        
                    setNotificationTitle("Pincnic Inofrmation");
                    setNotificationMessage("Update successfully");
                    setModalShow(true);
